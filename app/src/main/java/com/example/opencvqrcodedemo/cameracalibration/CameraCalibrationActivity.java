...
package com.example.opencvqrcodedemo.cameracalibration;
...
import com.example.opencvqrcodedemo.R;
...
public class CameraCalibrationActivity extends CameraActivity implements CvCameraViewListener2, OnTouchListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        qwe[0] = Manifest.permission.READ_EXTERNAL_STORAGE;
        qwe[1] = Manifest.permission.WRITE_EXTERNAL_STORAGE;
        requestPermissions(qwe, 6019);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.calibration) {
            ...
            return true;
        } else if (itemId == R.id.undistortion) {
            mOnCameraFrameRender =
